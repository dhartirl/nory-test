...
class ModifiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modifier" do
    assert_difference("Modifier.count") do
      post modifiers_url, params: { modifier: { name: @modifier.name, price: @modifier.price, type: @modifier.type } }
    end
  ...
  test "should update modifier" do
    patch modifier_url(@modifier), params: { modifier: { name: @modifier.name, price: @modifier.price, type: @modifier.type } }
